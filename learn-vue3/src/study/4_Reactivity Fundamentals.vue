    ...
    ----------------------------------------------------------------------------------------------------------------------------
      ...
      추가적인 Ref 언래핑 세부 사항
        ...
        템플릿에서 래핑 해제 시 주의 사항
          ...
          표현식을 평가할 때 object.id가 언래핑되지 않고 ref 객체로 남아 있기 때문에 랜더링된 결과는 [object object]1이 된다. 
          ...
          주목해야할 또 다른 사항은 ref가 텍스트 보간(예: {{  }} 태그)의 최종 평가 값이 경우 래핑되지 않으므로 다음은 1을 랜더링한다는 것이다.
