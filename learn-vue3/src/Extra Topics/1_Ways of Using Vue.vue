...
<!--  
    ...
    -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        풀스텍 / SSR
            ...
            이는 브라우저가 대부분 비어 있는 HTML 페이지를 수신하고, 무엇을 렌더링하기 전에 JavaScript가 로드될 때까지 기다려야 하기 때문이다.

            Vue는 Vue 앱을 서버의 HTML 문자열로 "렌더링"하는 first-class API를 제공한다. 이를 통해 서버는 이미 렌더링된 HTML을 보낼 수 있으므로,
    ...
    -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        잼스택 / SSG
            ...
            즉, 전체 애플리케이션을 HTML로 미리 렌더링하여 정적 파일로 제공할 수 있다. 이렇게 하면 사이트 성능이 향상되고 각 요청에 대해 페이지를 동적으로 렌더링할 필요가 없으므로
